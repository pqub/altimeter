...
export const LS_ENDPOINTS = {
    GET_ALL_CASCADE_TRAJECTORIES: 'exa.language_server_pb.LanguageServerService/GetAllCascadeTrajectories',
    GET_CASCADE_METADATA: 'exa.language_server_pb.LanguageServerService/GetCascadeTrajectoryGeneratorMetadata',
